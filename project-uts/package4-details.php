        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Rp 15.000.000 - Rp 20.000.000</h4>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div>
              <img src="assets/images/product-4-370x270.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
          ...
          <div class="col-md-6">
              ...
              <p><i class="fa fa-map-marker"></i>  <strong>Badi-Gorela-Mulla Talai Rd, Haridas Ji Ki Magri, Pichola, Udaipur, Rajasthan 313001, India</strong></p>
              <br>
              <?php 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
               ...
               <tbody>
                    ...
                    <tr>
                         ...
                         <td>01-06-2021</td>
                         <td>03-06-2021</td>
                         <td>Rp 15.000.000 total price</td>
                    </tr>
               </tbody>
          </table>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $strSQL = "INSERT INTO enquirytheberoi (name, email, phone, date1, date2, pesan) 
