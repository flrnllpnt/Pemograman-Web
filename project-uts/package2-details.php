        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Rp 4.000.000 - Rp 5.000.000</h4>

              <h2>Tongging Point Hotel</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div>
              <img src="assets/images/product-2-370x270.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
          ...
          <div class="col-md-6">
              ...
              <p><i class="fa fa-map-marker"></i>  <strong>Jl. Raya Merek No.KM, RW.9, Kodon-Kodon, Merek, Kabupaten Karo, Sumatera Utara 22173</strong></p>
              <br>
              <?php 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $strSQL = "INSERT INTO enquirytongging (name, email, phone, date1, date2, pesan) 
