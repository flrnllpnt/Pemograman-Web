        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Rp 5.000.000 - Rp 6.000.000</h4>

              <h2>Nusa Dua Beach Hotel & Spa</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div>
              <img src="assets/images/product-3-370x270.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
          ...
          <div class="col-md-6">
              <p class="lead">
                   <i class="fa fa-calendar"></i> Available: Spring &nbsp;&nbsp; <i class="fa fa-cube"></i> 2 nights &nbsp;&nbsp; <i class="fa fa-plane"></i> Flight included
              </p>

              <br>

              <p><i class="fa fa-map-marker"></i>  <strong>Kawasan Pariwisata Nusa Dua Lot. North 4, Jl. Nusa Dua, Benoa, South Kuta, Badung Regency, Bali 80363</strong></p>
              <br>
              <?php 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
               ...
               <tbody>
                    <tr>
                         ...
                         <td>01-06-2021</td>
                         <td>02-06-2021</td>
                         <td>Rp 2.500.000 per night</td>
                    </tr>

                    <tr>
                         <td>Raflesia (flight include)</td>
                         <td>01-06-2021</td>
                         <td>03-06-2021</td>
                         <td>Rp 5.000.000 total price</td>
                    </tr>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $strSQL = "INSERT INTO enquirynusadua (name, email, phone, date1, date2, pesan) 
