        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Rp 40.000.000 - Rp 50.000.000</h4>

              <h2>Pink Building Resort</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div>
              <img src="assets/images/product-5-370x270.jpg" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
          ...
          <div class="col-md-6">
              ...
              <p><i class="fa fa-map-marker"></i>  <strong>108-10 Rockaway Beach Dr, Queens, NY 11694, Amerika Serikat</strong></p>
              <br>
              <?php 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
               ...
               <tbody>
                    <tr>
                         ...
                         <td>01-06-2021</td>
                         <td>02-06-2021</td>
                         <td>Rp 20.000.000 per night</td>
                    </tr>
                    <tr>
                         <td>Rose (flight exclude)</td>
                         <td>01-06-2021</td>
                         <td>03-06-2021</td>
                         <td>Rp 30.000.000 per night</td>
                    </tr>
                    <tr>
                         <td>Jasmine (flight include)</td>
                         <td>01-06-2021</td>
                         <td>04-06-2021</td>
                         <td>Rp 40.000.000 total price</td>
                    </tr>
               </tbody>
          </table>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $strSQL = "INSERT INTO enquirypinkbuild (name, email, phone, date1, date2, pesan) 
