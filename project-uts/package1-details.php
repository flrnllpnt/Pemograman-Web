        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Rp 3.000.000 - Rp 4.000.000</h4>

              <h2>The Manohara Hotel Yogyakarta</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              <p class="lead">
                   <i class="fa fa-calendar"></i> Available: Spring &nbsp;&nbsp; <i class="fa fa-cube"></i> 4 nights &nbsp;&nbsp; <i class="fa fa-plane"></i> Flight included
              </p>

              <br>

              <p><i class="fa fa-map-marker"></i>  <strong>Jl. Affandi No.35, Gejayan, Caturtunggal, Kec. Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</strong></p>
              <br>
              <?php 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
               ...
               <tbody>
                    <tr>
                         ...
                         <td>01-06-2021</td>
                         <td>02-06-2021</td>
                         <td>Rp 900.000 per night</td>
                    </tr>

                    <tr>
                         <td>Rose (flight exclude)</td>
                         <td>01-06-2021</td>
                         <td>03-06-2021</td>
                         <td>Rp 1.000.000 per night</td>
                    </tr>

                    <tr>
                         <td>Raflesia (flight exclude)</td>
                         <td>01-06-2021</td>
                         <td>04-06-2021</td>
                         <td>Rp 1.500.000 per night</td>
                    </tr>

                    <tr>
                         <td>Jasmine (flight include)</td>
                         <td>01-06-2021</td>
                         <td>05-06-2021</td>
                         <td>Rp 3.000.000 total price</td>
                    </tr>
               </tbody>
          </table>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $strSQL = "INSERT INTO enquirymanohara (name, email, phone, date1, date2, pesan) 
