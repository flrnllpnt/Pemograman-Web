...
<body>
    ...
    $pekerjaan_ayahErr = $pekerjaan_ibuErr = $penghasilan_ayahErr = $penghasilan_ibuErr = $psErr = $informasiErr = $rekomendasiErr = $rekomendasi1Err = "";
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["informasi"])) {
            $informasiErr = "Informasi is required";
        } else {
            $informasiErr = test_input($_POST["informasi"]);
        }
        if (empty($_POST["rekomedasi"])) {
            $rekomendasiErr = "Rekomendasi is required";
        } else {
            $rekomendasiErr = test_input($_POST["rekomendasi"]);
        }
    }
        ...
        <form id="form" method="post">
            ...
            <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $jalurErr;?></span>
                        <select class="form-control" name="jalur_penerimaan">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label><dt>Nama Calon Mahasiswa (Sesuai Akte Kelahiran)</dt></label>
                        <span class="error">* <?php echo $namaErr;?></span>
                        <input type="text" name="nama_mahasiswa" class="form-control" placeholder="Silahkan masukan nama lengkap">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="ttl" class="form-control" placeholder="Silahkan masukkan tempat, tanggal/bulan/tahun lahir...">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nik" class="form-control" placeholder="Silahkan masukkan Nomor Induk Kependudukan...">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="alamat" rows="2" id="alamat" placeholder="Silahkan masukkan alamat lengkap..."></textarea>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $kpErr;?></span>
                        <input type="text" name="kode_pos" class="form-control" placeholder="Silahkan masukkan kodepos...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_hp" class="form-control" placeholder="Silahkan masukkan no handphone...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" placeholder="Silahkan masukkan email...">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $asal_sklhErr;?></span>
                        <input type="text" name="asal_sklh" class="form-control" placeholder="Silahkan masukkan asal sekolah...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $kota_sklhErr;?></span>
                        <input type="text" name="kota_sklh" class="form-control" placeholder="Silahkan masukkan kota asal sekolah...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $jurusan_sklhErr;?></span>
                        <input type="text" name="jurusan_sklh" class="form-control" placeholder="Silahkan masukkan jurusan sekolah...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $tahun_llsErr;?></span>
                        <input type="text" name="tahun_lls" class="form-control" placeholder="Silahkan masukkan tahun lulus...">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $biayaErr;?></span>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <span class="error">* <?php echo $nama_ayahErr;?></span>
                        <input type="text" name="nama_ayah" class="form-control" placeholder="Silahkan masukkan nama ayah...">
                ...
                <div class="col-sm-6">
                    ...
                    <span class="error">* <?php echo $nama_ibuErr;?></span>
                        <input type="text" name="nama_ibu" class="form-control" placeholder="Silahkan masukkan nama ibu..." >
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label><dt>Alamat</dt></label>
                        <span class="error">* <?php echo $alamat_ortuErr;?></span>
                        <textarea class="form-control" name="alamat_ortu" rows="2" id="alamat" placeholder="Silahkan masukkan alamat lengkap..."></textarea>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                    <label><dt>Kode Pos</dt></label>
                    <span class="error">* <?php echo $kp_ortuErr;?></span>
                        <input type="text" name="kode_posortu" class="form-control" placeholder="Silahkan masukkan kodepos...">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                    <label><dt>No. Handphone</dt></label>
                    <span class="error">* <?php echo $nohp_ortuErr;?></span>
                        <input type="text" name="no_hportu" class="form-control" placeholder="Silahkan masukkan no handphone...">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label><dt>Pendidikan Terakhir Ayah</dt></label>
                        <span class="error">* <?php echo $pendidikan_ayahErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $pendidikan_ibuErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $status_ayahErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $status_ibuErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $pekerjaan_ayahErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $pekerjaan_ibuErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $penghasilan_ayahErr;?></span>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <span class="error">* <?php echo $penghasilan_ibuErr;?></span>
                ...
                <div class="form-group" name = "informasi" >
                    <label><dt>Informasi UPJ diperoleh dari :</dt></label> 
                    <span class="error">* <?php echo $informasiErr;?></span> 
                ...
                <br>
                <div class="form-group" name = "rekomendasi1">
                <label><dt>Direkomendasikan oleh :</dt></label>  <br>
                <span class="error">* <?php echo $rekomendasi1Err;?></span>
                <label><dt>PRODI/UNIT</dt></label> <br>
                ...
                <br>
                <div class="col-sm-6">
                    <div class="form-group" name="rekomendasi">
                    <label><dt>Nama Perekomendasi & No. HP</dt></label>
                    <span class="error">* <?php echo $rekomendasiErr;?></span>
                        <input type="text" name="nama_rekomendasi" class="form-control" placeholder="Nama Perekomendasi & No Handphone....">
